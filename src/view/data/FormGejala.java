...
public class FormGejala extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FormPenyakitt
     */
    ...
    private void tampilData(String keyword) {
        ...
        try {
            ...
            String sql = "SELECT * FROM tbl_gejala ";
            
            if (!keyword.isEmpty()) {
                sql += "WHERE kode_gejala LIKE '%" + keyword + "%' OR nama_gejala LIKE '%" + keyword + "%' ";
            }
            sql += "ORDER BY kode_gejala ASC";
            ...
            JOptionPane.showMessageDialog(this, "Error tampil data Gejala: " + e.getMessage());
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createMatteBorder(2, 1, 2, 1, new java.awt.Color(0, 0, 0)), "Form Gejala Ikan Nila", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 18))); // NOI18N
        ...
        tblGejala.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        tblGejala.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No", "Kode Gejala", "Deskripsi Gejala Klinis"
            }
        ) {
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addComponent(btnHapus, javax.swing.GroupLayout.DEFAULT_SIZE, 276, Short.MAX_VALUE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(btnEdit, javax.swing.GroupLayout.DEFAULT_SIZE, 263, Short.MAX_VALUE))
        ...
        jLabel11.setText("<html><center>SISTEM PAKAR DIAGNOSA PENYAKIT IKAN NILA DZAWIL FARM<br><font size=\"5\" color=\"#000000\"><b>Kelola Data Master Gejala</b></font><br><font size=\"4\" color=\"#333333\"><i>Metode Certainty Factor</i></font></center></html>");
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        ...
        view.dialog.DialogGejala popUp = new view.dialog.DialogGejala(this, true);
        popUp.modeTambah();
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        int baris = tblGejala.getSelectedRow();
        if (baris == -1) {
            JOptionPane.showMessageDialog(this, "Pilih baris data di tabel yang mau dihapus terlebih dahulu!");
            return;
        }

        String kodeYgDihapus = tblGejala.getValueAt(baris, 1).toString();

        int konfirmasi = JOptionPane.showConfirmDialog(this, "Yakin hapus data gejala " + kodeYgDihapus + "?", "Konfirmasi", JOptionPane.YES_NO_OPTION);
        if (konfirmasi == JOptionPane.YES_OPTION) {
            try {
                Connection con = KoneksiDB.getKoneksi();
                PreparedStatement pst = con.prepareStatement("DELETE FROM tbl_gejala WHERE kode_gejala=?");
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        String kode = tblGejala.getValueAt(baris, 1).toString();
        String gejala = tblGejala.getValueAt(baris, 2).toString();

        view.dialog.DialogGejala popUp = new view.dialog.DialogGejala(this, true);
        popUp.modeEdit(kode, gejala);
        popUp.setVisible(true);
        tampilData("");
