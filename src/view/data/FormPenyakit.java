...
public class FormPenyakit extends javax.swing.JFrame {
    ...
    private void aturFormatTabel() {
        ...
        // Sekarang jumlah kolomnya jadi 6
        if (tblPenyakit.getColumnCount() == 6) {
            ...
            cm.getColumn(1).setPreferredWidth(80);   // Kode Penyakit
            cm.getColumn(2).setPreferredWidth(150);  // Nama Penyakit
            cm.getColumn(3).setPreferredWidth(250);  // Deskripsi (TAMBAHAN BARU)
            cm.getColumn(4).setPreferredWidth(250);  // Solusi
            cm.getColumn(5).setPreferredWidth(250);  // Pencegahan
            
            // 2. Pasang Sihir Turun ke Bawah (Word Wrap)
            // Terapin ke Deskripsi, Solusi, dan Pencegahan
            ...
            // 3. Rata Tengah buat No & Kode Penyakit
    ...
    private void tampilData(String keyword) {
        DefaultTableModel model = (DefaultTableModel) tblPenyakit.getModel();
        model.setRowCount(0);
        
        try {
            Connection con = KoneksiDB.getKoneksi();
            Statement st = con.createStatement();
            String sql = "SELECT kode_penyakit, nama_penyakit, solusi, pencegahan FROM tbl_penyakit ";
    ...
    private void initComponents() {
        ...
        jLabel11.setText("FORM DATA PENYAKIT");
        ...
        mainContent.setBackground(new java.awt.Color(255, 153, 200));
        mainContent.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.MatteBorder(null), "TABEL DATA PENYAKIT", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 3, 18), new java.awt.Color(1, 1, 1))); // NOI18N
                    ...
                    .addGroup(mainContentLayout.createSequentialGroup()
                        ...
                        .addGroup(mainContentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(mainContentLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(btnEdit, javax.swing.GroupLayout.DEFAULT_SIZE, 162, Short.MAX_VALUE))
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        // 1. Cek apakah user sudah milih baris di tabel?
        ...
        // 2. Tarik data sesuai index kolom yang baru (Ketambahan Deskripsi)
        ...
        // 3. Lempar 5 parameter itu ke DialogPenyakit
